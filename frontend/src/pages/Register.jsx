  ...
  return (
    <div className="min-h-screen bg-gradient-animated flex items-center justify-center p-6">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-40 -left-40 w-80 h-80 bg-sky-500/20 rounded-full blur-3xl" />
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="glass rounded-3xl p-8">
          ...
          <p className="text-white/60 text-center mb-8">Start organizing your work today</p>
